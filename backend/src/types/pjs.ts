  ...
  import type { FrameSupportScheduleDispatchTime, PolkadotRuntimeCommonImplsVersionedLocatableAsset } from '@polkadot/types/lookup';
  ...
  interface PalletRcMigratorCall extends Enum {
    ...
    readonly type: 'ForceSetStage' | 'ScheduleMigration' | 'StartDataMigration' | 'UpdateAhMsgProcessedCount';
  }
