...
export type EventType = 'rcHead' | 'ahHead' | 'rcBalances' | 'rcXcmMessageCounter' | 'ahXcmMessageCounter' | 'rcStageUpdate' | 'ahStageUpdate' | 'dmpLatency' | 'dmpQueueEvent' | 'umpLatency' | 'umpMetrics' | 'umpQueueEvent';
...
export const EventSourceProvider: React.FC<EventSourceProviderProps> = ({ 
  ...
  const createEventSource = useCallback((url: string) => {
    ...
    const allEventTypes: EventType[] = ['rcHead', 'ahHead', 'rcBalances', 'rcXcmMessageCounter', 'ahXcmMessageCounter', 'rcStageUpdate', 'ahStageUpdate', 'dmpLatency', 'dmpQueueEvent', 'umpLatency', 'umpMetrics', 'umpQueueEvent'];
